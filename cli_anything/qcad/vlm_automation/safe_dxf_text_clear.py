#!/usr/bin/env python3
"""
Safe DXF text-clearing script for LibreDWG round-trip.
Replaces entity text with a single space (invisible, parser-valid)
instead of empty string (breaks AutoCAD/TrueView).
